      ...
      window.addEventListener(
        ...
        function (t) {
          ...
          if (!o.default.isAllowed(t.origin, window, l))
            throw new Error(
              t.origin + ' is not allowed to override this storefront.'
            );
          !(function (t, e) {
            if (
                ...
                (a =
                  'string' == typeof e.js[0]
                    ...
                    : e.js
                        .filter(function (t) {
                          return (
                            !t.namespaceToCheck || !window[t.namespaceToCheck]
                          );
                        })
                        .map(function (t) {
                          return t.src;
      ...
      o = (function () {
        ...
        return (
          ...
          (t.isAllowed = function (e, n, r) {
            if (!/^(https?:)\/\/([-.a-zA-Z0-9]+(:[0-9]{1,5})?)$/.test(e))
              return !1;
          ...
          (t.getSanitizedHostFromLocation = function (t) {
            var e =
              t.port ||
              ('https' === t.protocol.replace(/:/g, '') ? '443' : '80');
            return t.hostname + ':' + e;
          }),
