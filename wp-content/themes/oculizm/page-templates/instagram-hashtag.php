...
/* Template Name: Instagram Hashtag */
	...
	<div class="post-grid-container">
		...
		<div class="tabs simple-tabs">
			<div class='tab-headers'>
				<div class='tab-header active' name='top'>Top</div>
				<div class='tab-header' name='recent'>Recent</div>
			</div>
			<div class="tab-bodies">
				<div class="tab-body post-grid active" name="top"></div>
				<div class="tab-body post-grid" name="recent"></div>
			</div>
		</div>
